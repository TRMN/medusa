...
<img src="{{asset($user->getShoulderPatchPath())}}" alt="{{$user->getAssignmentName('primary')}}" title="{{$user->getAssignmentName('primary')}}" class="patch{{$user->getRibbons('LS')?' patch-top-margin' : ''}}"><br />
@endif
