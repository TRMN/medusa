...
class ReportController extends Controller
{
    ...
    public function index()
    {
        ...
        $validTypes = Medusaconfig('report.valid_types', ['ship', 'station', 'small_craft', 'lac']);
    ...
    public function create()
    {
        ...
        if (isset($report) === true && empty($report->report_sent) === true) {
            ...
            return view('report.chapter-edit', ['report' => $report]);
        ...
        return view('report.chapter-create', $viewData);
    }
    ...
    public function show($id)
    {
        ...
        return view('report.chapter-show', ['report' => $report]);
    }
