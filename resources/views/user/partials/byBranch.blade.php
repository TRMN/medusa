<table class="trmnTableWithActions compact row-border">
    <thead>
    <tr>
        <th><span class="fi-star red" data-toggle="tooltip" title="New Exams Posted">&nbsp;</span></th>
        <th>Rank</th>
    ...
    @if(isset($users[$branch]))
        @foreach( $users[$branch] as $user )
            <tr class="zebra-odd">
                <td>@if($user->hasNewExams()) <span class="fi-star red" data-toggle="tooltip" title="New Exams Posted">&nbsp;</span> @endif
                </td>
