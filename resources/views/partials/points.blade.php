...
<div class="container-fluid zebra" id="peerages">
    ...
    <div class="row pp-row margin-bottom-10 padding-bottom-10">
        ...
        <div class="col-sm-4 text-right">
            {{Form::select('points[peerage]', [
                    'B' => 'Baron/Baroness',
                    'Fr' => 'Freiherr/Freifrau',
                    'E' => 'Earl/Countess',
                    'Gr' => 'Graf/Gräfin',
                    'S' => 'Steadholder',
                    'D' => 'Duke/Duchess',
                    'He' => 'Herzog/Herzogin',
                    'L' => 'Senator for Life',
                    'G' => 'Grand Duke/Grand Duchess',
                    'Fu' => 'Fürst/Fürstin',
                ], empty($user->points['peerage']) ? null : $user->points['peerage'], ['placeholder' => 'Select Peerage', 'class' => 'pp-calc-select', 'data-target' => 'peerage', 'disabled' => !$permsObj->hasPermissions(['EDIT_MEMBER'])])}}
