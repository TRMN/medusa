@if(!empty($user->assignment) && !empty($user->getPrimaryAssignmentId()))
    <div class="NordItalic ninety padding-5">
        ...
        @if($user->checkRostersForNewExams())
            <br /><span class="fa fa-exclamation-triangle orange Incised901Light">One or more crew members have had new exams posted since your last login.<br />View your <a href="{!!route('chapter.show',$user->getPrimaryAssignmentId())!!}">roster</a> for more information</span>
        @endif
    </div>
    <br />
