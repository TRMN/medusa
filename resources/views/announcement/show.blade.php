...
@section('content')
    ...
    <div class="meta"><a href="{!! route( 'announcement.index') !!}" data-toggle="tooltip"
                         title="Back to Announcement List">Back to Announcement List</a></div>
    <div class="meta">
        @if( $announcement->user )
            <div class="author">
                Written By
                <span>{!! $announcement->user->getGreeting() !!} {!! $announcement->user->last_name !!}</span>
            </div>
        @endif
