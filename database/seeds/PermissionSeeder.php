...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $perms = [
            ...
            'ADD_UNIT' => 'Stand-up an Army Command or Unit',
            'EDIT_UNIT'=> 'Edit an Army Command or Unit',
            'DELETE_UNIT' => 'Stand-down an Army Command or Unit',
            'ADD_MARDET' => 'Stand-up a Marine Detachment',
            'EDIT_MARDET' => 'Edit a Marine Detachement',
            'DELETE_MARDET' => 'Stand-down a Marine Detachement',
            'CREATE_ECHELON' => 'Activate an Echelon',
            'EDIT_ECHELON' => 'Edit an echelon',
            'DEL_ECHELON' => 'Deactivate an echelon',
