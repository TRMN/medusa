...
class WelcomeLetter extends Migration
{
    ...
    public function up()
    {
        \App\MedusaConfig::set('bupers.welcome', '<p>Greetings and welcome aboard The Royal Manticoran Navy, The Official Honor Harrington Fan Association (TRMN). You
...
Manticoran Alliance as portrayed in the Honor Harrington series of novels. You are assigned to %CHAPTER%. Your
commanding officer is %CO%. Your commanding officer can be contacted at <a href="mailto:%COEMAIL%">%COEMAIL%</a>.</p>
...
<p>Again, welcome to TRMN and the Honorverse.</p>');
    ...
    <tr>
        <td valign="middle"><img src="%patch%"
